...
const TermsOfService = () => {
	return ( 
		<div className={Styles.container}>
			<h1 className={Styles.headline}>Terms & Conditions</h1>
			<p className={Styles.paragraph} >
				...
				intellectual property rights related to it, still belong to Obuv Network Private Limited.
			</p>

			<p className={Styles.paragraph} >
				Obuv Network Private Limited is committed to ensuring that the app is as useful and efficient as
			...
			<p className={Styles.paragraph} >
				The TheNewzKit app stores and processes personal data that you have provided to us, in order to
				...
				security features and it could mean that the TheNewzKit app won’t work properly or at all.
			</p>
			...
			<p className={Styles.paragraph} >
				...
				<ul>
					<li>[Google Play Services](https://policies.google.com/terms)</li>
					<li>[Google Analytics for Firebase](https://firebase.google.com/terms/analytics)</li>
					<li>[Expo](https://expo.io/terms)</li>
				</ul>
			</p>

			<p className={Styles.paragraph} >
				You should be aware that there are certain things that Obuv Network Private Limited will not take
				responsibility for. Certain functions of the app will require the app to have an active internet
				connection. The connection can be Wi-Fi, or provided by your mobile network provider, but Obuv
				Network Private Limited cannot take responsibility for the app not working at full functionality if you
			...
			<p className={Styles.paragraph} >
				...
				please be aware that we assume that you have received permission from the bill payer for using the
				app.
			</p>

			<p className={Styles.paragraph} >
				Along the same lines, Obuv Network Private Limited cannot always take responsibility for the way you
				use the app i.e. You need to make sure that your device stays charged – if it runs out of battery and you
				can’t turn it on to avail the Service, Obuv Network Private Limited cannot accept responsibility.
				With respect to Obuv Network Private Limited’s responsibility for your use of the app, when you’re
				...
				available to you. Obuv Network Private Limited accepts no liability for any loss, direct or indirect, you
			...
			<p className={Styles.paragraph} >
				...
				Obuv Network Private Limited does not promise that it will always update the app so that it is relevant
				to you and/or works with the Android & iOS version that you have installed on your device. However,
				you promise to always accept updates to the application when offered to you, We may also wish to stop
			...
			<h1 className={Styles.headline}>Changes to This Terms and Conditions</h1>
			<p className={Styles.paragraph} >
			...
			<p className={Styles.paragraph} >These terms and conditions are effective as of 2021-09-02</p>
