...
export default function Home({ latest, allCategoryPosts, websiteDetails, subdomain, list }) {
    ...
    return (
        <div className={styles.container}>
            ...
            <header>
                <Navigation logo={websiteDetails.logo} facebookUrl={websiteDetails.facebookUrl} twitterUrl={websiteDetails.twitterUrl} youtubeLink={websiteDetails.youtubeLink} whatsappGroupUrl={websiteDetails.whatsappGroupUrl} aboutUs={websiteDetails.aboutUs} />
            </header>
